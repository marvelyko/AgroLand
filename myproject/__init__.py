...
def index():
    ...
    if form.validate_on_submit():
        ...
        return render_template('index.html',title="Company Name",form=form,names=names,scores=scores,res=res)
    k="49"
    return render_template('index.html',title="Company Name",form=form,k=k,res=res,names=names,scores=scores)
